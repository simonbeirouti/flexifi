...
contract BusinessPooling is ReentrancyGuard, Ownable {
    ...
    uint256 public constant MIN_DEPOSIT = 10000 * 1e18; // Minimum deposit of 10,000 tokens, assuming 18 decimal places
    ...
    function depositFor(address investor, uint256 amount) public {
        ...
        balances[investor] += amount; // Update the balance linked to the investor
